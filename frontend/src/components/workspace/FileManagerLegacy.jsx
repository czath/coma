...
export default function FileManagerLegacy({ onSwitchUI }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            {/* UI Switcher Button (Bottom Left) */}
            <div className="fixed bottom-6 left-6 z-[100]">
                <button
                    onClick={onSwitchUI}
                    className="flex items-center gap-3 px-4 py-2 bg-white border border-gray-200 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl font-black uppercase tracking-widest transition-all shadow-sm group outreach"
                >
                    ...
                    <span className="text-[10px] hidden lg:block whitespace-nowrap">switch to flex ui</span>
                </button>
            </div>
        </div >
    );
