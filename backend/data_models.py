...
class TermSheetResponse(BaseModel):
    ...
    payment_terms: TermSheetField = Field(description="Extracted field.")
    payment_milestones: TermSheetField = Field(description="Extracted field.")
    ...
    termination: TermSheetField = Field(description="Extracted field.")
